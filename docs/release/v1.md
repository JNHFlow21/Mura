...
The command downloads the Release DMG, installs `Mura.app` into `/Applications`, removes the unsigned-build quarantine marker, and opens Mura. If macOS asks for permission, enter your login password in Terminal.
